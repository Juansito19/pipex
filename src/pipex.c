...
/*   Updated: 2025/09/20 18:40:07 by jbrosio          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	close(vars->fd[1]);
	vars->fd_write = open(av[4], O_CREAT | O_WRONLY | O_TRUNC, 0644);
	if (vars->fd_write < 0)
		ft_puterr(NULL, 2, vars);
...
// void	first_child_process(char **av, t_command *vars)
// {
// 	(void) av;
// 	(void) vars;
// 	printf("hijo empieza\n");
...
// void	father_process(int ac, char **av, char **envp, t_command *vars)
// {
// 	(void) av;
// 	(void) ac;
// 	find_path(vars, envp);
...
// 		ft_puterr(NULL, 11, vars);
// 	else if (vars->pid == 0)
// 		first_child_process(av, vars);
// 	else
// 	{
// 		// close(vars->fd[1]);
// 		printf("padre hace cosas\n");
// 		printf("padre espera\n");
// 		waitpid(vars->pid, NULL, 0);
// 		printf("hijo termina\n");
// 	}
